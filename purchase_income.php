...
<div style="text-align: center; margin-bottom: 20px;">
    <a href="settled_purchases_history.php" class="button-view">View Settled Purchases</a>
    <a href="unsettled_purchases_history.php" class="button-view">View Unsettled Purchases</a>
</div>
<table>
    <tr>
