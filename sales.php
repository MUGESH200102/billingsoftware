...
<head>
  ...
  <style>
    ...
    .details th, .details td, .tax-details th, .tax-details td {
        border: 1px solid #ccc;
        padding: 10px;
        text-align: left;
    }

    .details th, .tax-details th {
...
<body>
    <div class="invoice-container container mt-5">
        <div class="header">
            <h1>Tax Invoice</h1>
        ...
        <div class="section from-to row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn-primary mt-2" onclick="showAddNewModal()">+ Add New</button>
                </div>
                <div class="form-group">
        ...
        <div class="footer">
            <p><strong>Amount in Words:</strong> <span id="amountInWords">_____</span></p>
    ...
    <script>
        function addItem() {
            ...
            row.innerHTML = `
                ...
                <td><input type="number" class="form-control qty" value="1" oninput="updateTotals()" required></td>
                <td><input type="text" class="form-control unit" required></td>
                <td><input type="text" class="form-control hsnCode" required></td>
                <td><input type="number" class="form-control gst" value="18" oninput="updateTotals()" required></td>
                <td><input type="number" class="form-control unitPrice" value="0" oninput="updateTotals()" required></td>
